...
try:
  ...
  print("Your car was not a Car!")
finally:    #finally block gets executed every time irrespective of whether except block is executed or not
  print(f"Your garage has {len(ford_garage)} cars.")'''

#when we have return statement in both except/try and finally block then the finally return will take the precedence
#and if we have return in except but not in finally then also finally will get precedence and it will return None
